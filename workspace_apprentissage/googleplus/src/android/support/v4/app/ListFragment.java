...
public class ListFragment extends Fragment
{
  ...
  private void ensureList()
  {
    ...
    while (true)
    {
      ...
      break label42;
      label226: if (this.mProgressContainer != null)
  ...
  private void setListShown(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (paramBoolean1)
    {
      if (paramBoolean2)
      {
        this.mProgressContainer.startAnimation(AnimationUtils.loadAnimation(this.mActivity, 17432577));
        this.mListContainer.startAnimation(AnimationUtils.loadAnimation(this.mActivity, 17432576));
      }
      while (true)
      {
    ...
    if (paramBoolean2)
    {
      this.mProgressContainer.startAnimation(AnimationUtils.loadAnimation(this.mActivity, 17432576));
      this.mListContainer.startAnimation(AnimationUtils.loadAnimation(this.mActivity, 17432577));
    }
    while (true)
    {
  ...
  public View onCreateView(LayoutInflater paramLayoutInflater, ViewGroup paramViewGroup, Bundle paramBundle)
  {
    ...
    ListView localListView = new ListView(this.mActivity);
  ...
  public final void setListAdapter(ListAdapter paramListAdapter)
  {
    ...
    for (int i = 1; ; i = 0)
    {
      ...
      if (this.mList != null)
      {
        ...
        {
          IBinder localIBinder = this.mView.getWindowToken();
          boolean bool = false;
