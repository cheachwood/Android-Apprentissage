...
abstract class PicasaJsonReaderParser
{
  ...
  protected static ObjectField newObjectField(EntrySchema.ColumnInfo paramColumnInfo)
  {
    ...
    default:
      if (EsLog.isLoggable("iu.PicasaAPI", 6))
        Log.e("iu.PicasaAPI", "unexpected column " + paramColumnInfo.name + " of type " + paramColumnInfo.type);
      i = 11;
    case 0:
    case 1:
    case 3:
    ...
    throws IOException
  {
    ...
    if (EsLog.isLoggable("iu.PicasaAPI", 2))
      Log.v("iu.PicasaAPI", "   etag: --> " + str1 + ",entryCount=" + this.entryCount);
  }
    ...
    throws IOException
  {
    ...
    default:
      ...
      {
        if (EsLog.isLoggable("iu.PicasaAPI", 6))
          Log.e("iu.PicasaAPI", "error parsing value", localException2);
        paramJsonReader.skipValue();
      }
    case 0:
    case 1:
    ...
    while (true)
    {
      ...
      if (!bool)
      {
        ...
        if (EsLog.isLoggable("iu.PicasaAPI", 5))
          Log.w("iu.PicasaAPI", "parseAtomTimestamp", localException1);
      }
    }
  }
 ...
 * Qualified Name:     com.google.android.apps.plus.iu.PicasaJsonReaderParser
