...
public final class EsMatrixCursor extends AbstractCursor
{
  ...
  public EsMatrixCursor(String[] paramArrayOfString)
  {
    this(paramArrayOfString, 16);
  }

  public EsMatrixCursor(String[] paramArrayOfString, int paramInt)
  {
  ...
  public final class RowBuilder
  {
    ...
    public final RowBuilder add(Object paramObject)
    {
      ...
      Object[] arrayOfObject = EsMatrixCursor.this.data;
      int i = this.index;
      this.index = (i + 1);
 ...
 * Qualified Name:     com.google.android.apps.plus.phone.EsMatrixCursor
